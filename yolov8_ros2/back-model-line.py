...
from ultralytics.engine.results import Boxes  # ✅ needed to rebuild filtered boxes
...
class FollowLineNode(Node):
    def __init__(self):
        ...
        self.get_logger().info('🟢 PID + YOLOv8 node active with true confidence filtering.')
    ...
    def process_frame(self, frame):
            ...
            if r.boxes is not None:
                ...
                for b in r.boxes:
                    ...
                    if class_name.lower() == 'stop':
                        ...
                        self.get_logger().info(f"🛑 Stop sign detected! (conf: {conf:.2f})")
                        break
        ...
        # 🪞 Show filtered YOLO results + line-following
